...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TechnicalTest.Android.dll" comes first in this list. */
		"TechnicalTest.Android.dll",
		"Domain.TechnicalTest.dll",
		"Infrastructure.TechnicalTest.dll",
		"FormsViewGroup.dll",
		"SimpleInjector.dll",
		"SQLite-net.dll",
